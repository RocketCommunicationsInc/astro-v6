...
A Log is a tabular representation of application events and may include username, priority, equipment type, signal type, etc. As part of the [Notification System](https://astrouxds-v6.netlify.app/design-guidelines/notifications), Logs provide sorting and filtering function for examining events

## Guidelines

-   [Astro UXDS: Log](http://astrouxds-v6.netlify.app/ui-components/log)
-   [Astro UXDS: Notification System](https://astrouxds-v6.netlify.app/design-guidelines/notifications)
