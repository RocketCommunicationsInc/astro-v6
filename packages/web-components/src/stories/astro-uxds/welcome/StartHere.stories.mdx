...
<StyledDiv>
    <div>Warning: This documentation may be out of date</div>
    <p class="banner-text">
        This site is meant for version 6 of astro-web-components. If you are on version 7, please see <a href="https://astro-components.netlify.app/?path=/docs/astro-uxds-welcome-start-here--page">the current documentation.</a>
    </p>
</StyledDiv>
...
yourself, you may clone [the respository]('https://github.com/RocketCommunicationsInc/astro-v6/packages/web-components')

```sh
git clone git@github.com:RocketCommunicationsInc/astro-v6.git
```
...
<ul class="frameworks">
    <li class="framework">
        ...
        <a
            href="https://codesandbox.io/s/github/RocketCommunicationsInc/astro-v6/tree/main/packages/starter-kits/html-js-starter"
            target="_blank"
        >
            <img
    ...
    <li class="framework">
        ...
        <a
            href="https://codesandbox.io/s/github/RocketCommunicationsInc/astro-v6/tree/main/packages/starter-kits/angular-starter?file=/src/app/app.component.html"
            target="_blank"
        >
            <img
    ...
    <li class="framework">
        ...
        <a
            target="_blank"
            href="https://codesandbox.io/s/github/RocketCommunicationsInc/astro-v6/tree/main/packages/starter-kits/react-starter?fontsize=14&hidenavigation=1&theme=dark"
        >
            <img
    ...
    <li class="framework">
        <a href="?path=/docs/astro-uxds-welcome-vue--page">
        ...
        <a
            target="_blank"
            href="https://codesandbox.io/s/github/RocketCommunicationsInc/astro-v6/tree/main/packages/starter-kits/vue-starter"
        >
            <img
                alt="Edit Astro - Vue"
                src="https://codesandbox.io/static/img/play-codesandbox.svg"
    ...
    <li class="framework">
        ...
        <a
            target="_blank"
            href="https://codesandbox.io/s/github/RocketCommunicationsInc/astro-v6/tree/main/packages/starter-kits/svelte-starter"
        >
            <img
