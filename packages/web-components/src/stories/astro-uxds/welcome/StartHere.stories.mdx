...
<ul class="frameworks">
    ...
    <li class="framework">
        ...
        <a
            target="_blank"
            href="https://codesandbox.io/s/github/RocketCommunicationsInc/astro/tree/main/packages/starter-kits/vue-starter"
        >
            <img
                alt="Edit Astro - Vue"
                src="https://codesandbox.io/static/img/play-codesandbox.svg"
    ...
    <li class="framework">
        ...
        <a
            target="_blank"
            href="https://codesandbox.io/s/github/RocketCommunicationsInc/astro/tree/main/packages/starter-kits/svelte-starter"
        >
            <img
