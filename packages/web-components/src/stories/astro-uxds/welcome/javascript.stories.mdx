...
<link
    rel="stylesheet"
    href="https://unpkg.com/@astrouxds/astro-web-components@latest-v6/dist/astro-web-components/astro-web-components.css"
/>
<script
    type="module"
    src="https://unpkg.com/@astrouxds/astro-web-components@latest-v6/dist/astro-web-components/astro-web-components.esm.js"
></script>
```

### Via NPM

`npm i @astrouxds/astro-web-components@latest-v6`
