...
<Meta
    ...
    subcomponents={{ RuxCheckbox: 'rux-checkbox' }}
...
-   [Astro UXDS: Checkbox](https://astrouxds-v6.netlify.app/ui-components/checkbox)
-   [Astro UXDS: Form and Input Validation](https://astrouxds-v6.netlify.app/ui-components/validation)
...
<ArgsTable of="rux-checkbox-group" />
